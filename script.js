...
const images = [
{
  texture: textureLoader.load('https://iili.io/HEUZIvR.jpg'),
  colors: [[192, 208, 220], [217, 190, 174]] },

{
  texture: textureLoader.load('love.jpeg'),
...
let mouseDown = false;
const extraImages = [
{ file: 'love.jpeg', colors: [[208, 229, 224], [209, 209, 220]] },
{ file: 'love.jpeg', colors: [[191, 192, 184], [217, 200, 170]] },
{ file: 'love.jpeg', colors: [[217, 226, 233], [216, 220, 203]] },
{ file: 'love.jpeg', colors: [[206, 221, 226], [219, 213, 222]] },
{ file: 'love.jpeg', colors: [[199, 199, 210], [218, 203, 195]] }];
...
const hideHand = () =>
{
  gsap.to(hand, { opacity: 0, onComplete: () =>
                hintAnimation.pause()
                });
};
